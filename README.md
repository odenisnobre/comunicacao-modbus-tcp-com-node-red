...
3. Nodes de escrita em determinado registro:
	...
	+ O segundo node(randon) gera valores aleatórios dentro de um faixa configurado na sua interface e tem sua saída no parâmetro *msg.payload* conforme as configurações abaixo:</br>
